...
Options:
  --scenario <name>      Built-in scenario: smoke, combat, combat-skills, status-effects, character-name, starting-loadout, biome, trap, floor-modifier, skill-check, save-load, save-management, auth-local, map-generation, npc-event, full-run
