...
const levelGrowth: Record<HeroClass, StatId[]> = {
  ...
  duelist: ["dexterity", "strength", "luck", "endurance"],
  cleric: ["faith", "mind", "vigor", "endurance"],
  engineer: ["intelligence", "dexterity", "endurance", "mind"],
  witch: ["mind", "luck", "intelligence", "faith"],
  "grave-knight": ["vigor", "strength", "endurance", "faith"],
}
