...
- [ ] Harden the current action log into a fully typed host-validated command relay: host applies movement/combat/loot/village/tutorial commands, rejects invalid commands, broadcasts accepted results, and lets clients render from accepted host events instead of parallel local simulation.
